...
3) БАЗОВЫЕ КОМАНДЫ (создать репозиторий, добавить файл, удалить, коммит) {
...
11) ВЕТВЛЕНИЕ В GIT (killer feature) {
...
13) УЧАСТИЕ В ПРОЕКТЕ Глава 5 (Общие советы по правилам хорошего тона в GIT){
//? Проверка измененных файлов на лишние ПРОБЕЛЫ
...
14) ГИТХАБ Глава 6 (GitHub)(ВРЕМЕННО ПРОПУЩЕНА) {

}

15) ИНСТРУМЕНТЫ Git Глава 7 //* ПОЛЕЗНО *// {

ВЫБОР РЕВИЗИИ (способы обращения к одному коммиту) {
...
ПРИБЕРЕЖЕНИЕ И ОЧИСТКА //* ПОЛЕЗНО *// {
...
$ git grep --break --heading (выводит результаты в более читаемом виде)
...
ИСПРАВЛЕНИЕ ИСТОРИИ КОММИТОВ //* ПОЛЕЗНО *//{
