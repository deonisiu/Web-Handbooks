...
7) ОПЕРАЦИИ ОТМЕНЫ (commit --amend, reset, checkout) {
...
10) ПСЕВДОНИМЫ (config --global alias) (АЛИАСЫ - aliases) {
...
ВЫБОР РЕВИЗИИ (reglog, show, log) (способы обращения к одному коммиту) {
